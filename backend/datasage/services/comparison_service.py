        ...
        for pid in property_ids:
            ...
            items.append(
                PropertyComparisonItem(
                    ...
                    furnishing=prop.furnishing.value if hasattr(prop.furnishing, "value") else (str(prop.furnishing) if prop.furnishing else None),
                    facing=prop.facing.value if hasattr(prop.facing, "value") else (str(prop.facing) if prop.facing else None),
